...
const SIMPLE_NPCS = [
  ...
  },
  {
    ...
    dialogue: [
      ...
      ['\u201cThread Registry batches come through with classification codes, registration dates, and compliance windows.\u201d',
       '\u201cMost people don\u2019t realise how much paper a three-year check-in cycle generates. I find it interesting.\u201d'],
      ['\u201cThere is a provision in the pre-Reform commentary \u2014 not the current Accord code, the older one \u2014 about suspended capital sentences pending resonance recovery.\u201d'],
      ['\u201cThey maintained a category for it.',
       'Certain offences where the thread-bond was assessed as strong enough to be recalled.',
       'Body held in specified conditions. Case left open.\u201d'],
      ['\u201cThe philosophical problem is obvious once you see it.\u201d',
       '\u201cIf death can be reversed, what does a capital sentence actually impose?',
       'A delay. A very serious inconvenience, at most.\u201d'],
      ['\u201cThe Registry has arguments filed on both sides.',
       'One position: the finality was the point \u2014 the punishment required the possibility of irreversibility, even if that possibility went unused.',
       'The other: the whole category was moot if recall was available.\u201d',
       '\u201cNeither side resolved it.\u201d'],
      ['\u201cThe last notation in that commentary thread is dated forty years before the end of the Century War.\u201d',
       '\u201cAfter that \u2014 nothing. Resonance at that scale wasn\u2019t recorded again.\u201d'],
      ['\u201cThe provision stayed in the commentary.',
       'Capital punishment stayed.',
       'People stayed dead.\u201d',
  ...
  // Drenwick Office — district officer (Officer Veth)
  {
    ...
    get dialogue() {
      const pages = [
        ...
        ['\u201cThe district carries more active threads than the summary reports suggest.\u201d',
  ...
  // Corridor A2, Unit 1 — Fenwick (retired Halcyra administrator)
  {
    ...
    spriteType: 'patron',
    dialogue: [
      ['\u201cI served thirty-one years in the Halcyra provincial administration. Taxation records, mostly.\u201d',
      ...
      ['\u201cPeople romanticise Halcyra. The grandeur is real \u2014 the avenues, the record halls, the twin statues at the Accord Gate.\u201d',
       '\u201cBut it is also a city where everything takes three forms in triplicate and nothing moves quickly.\u201d',
       '\u201cI retired here for the quiet. I got mud instead of quiet. Close enough.\u201d'],
      ['\u201cThe Civic Class is the best thing the Empire has done in three hundred years.\u201d',
  ...
  // Corridor B1, Unit 1 — Hazel (private tutor, furious about Education Act)
  {
    ...
    spriteType: 'clerk',
    dialogue: [
      ['\u201cThe Education Act of 871 allows the Empire to enroll any child in an Imperial school, compulsorily, up to age twelve.\u201d',
       '\u201cAny child. Without consulting the parents about curriculum. Without consulting me.\u201d',
       '\u201cI had six students. Now I have two.\u201d'],
      ['\u201cThe Imperial schools are not bad.\u201d',
       '\u201cI\u2019ll admit that. Arithmetic, letters, Empire history, civic law basics. It\u2019s adequate.\u201d',
       '\u201cBut I was teaching Brennan advanced geometry at age nine. They won\u2019t do that. They teach to the level of the group.\u201d'],
      ['\u201cThe Act was passed to address illiteracy in the outer provinces.\u201d',
       '\u201cWhich is a genuine problem and a genuine good intention.\u201d',
       '\u201cIt just also, incidentally, dismantled the private tutoring economy in every district it touched. I\u2019m sure they considered that carefully in Halcyra.\u201d'],
      ['\u201cI know Brennan\u2019s mother, and she\u2019s happy about it.\u201d',
       '\u201cShe says the Imperial school covers the civic registration exam material.\u201d',
  ...
  // Corridor C1, Unit 2 — Sova (Halcyra transfer, hates mud)
  {
    ...
    spriteType: 'clerk',
    dialogue: [
      ['\u201cI was transferred here from the Halcyra district office fourteen months ago.\u201d',
       '\u201cI was told it was a lateral move with regional experience benefits.\u201d',
  ...
  // Always present; no dayoff variation.
  {
    ...
    spriteType: 'patron',
    dialogue: [
      ['\u201cWhen the aetherrail opened, the Registry moved northeast within two years.\u201d',
       '\u201cFewer officials passing through after that. District office lost staff gradually \u2014 not all at once, just a floor\u2019s worth over ten years.\u201d'],
      ['\u201cThe good captains knew every sandbar between here and the second lock.\u201d',
       '\u201cGoods used to come from three settlements further north than anything reaches now. The harbormaster posting was sought after, back then.\u201d'],
      ['\u201cCaptain I knew worked the upper run. Rareborn.\u201d',
       '\u201cUsed to check in here every three years for it. Now she goes northeast. Longer trip. She doesn\u2019t complain.\u201d'],
      ['\u201cThey\u2019ve watered it down again.\u201d',
       '\u201cEvery other winter they water it down. I haven\u2019t decided if it\u2019s worth mentioning.\u201d'],
    ],
    flag_required: null,
    flag_sets:     null,
    action:        null,
  ...
  // One night in Calwick, moving on tomorrow. Has opinions about every stretch of canal.
  {
    ...
    dialogue: [
      ['\u201cOne night.\u201d',
       '\u201cThe barge is tied at the south bank. We continue at dawn.\u201d'],
      ['\u201cThe Calwick stretch is the smoothest on the lower run.\u201d',
       '\u201cNo sediment problems, decent depth, gates open in under a minute.\u201d',
       '\u201cSomeone maintains this canal properly. I notice when someone does.\u201d'],
      ['\u201cEast of here it gets complicated.\u201d',
       '\u201cThird weir\u2019s been half-draw for months.\u201d',
       '\u201cYou feel it in the approach \u2014 the current bunches up against it.\u201d'],
    ],
    flag_required: null,
    flag_sets:     null,
    action:        null,
