...
window.HOLLIS_FARMHOUSE_MAP = HOLLIS_FARMHOUSE_MAP;
window.WRENNA_COTTAGE_MAP   = WRENNA_COTTAGE_MAP;
...
window.DUNGEON8_WEST_LOWER_MAP = DUNGEON8_WEST_LOWER_MAP;
window.DUNGEON8_EAST_LOWER_MAP = DUNGEON8_EAST_LOWER_MAP;
window.DUNGEON8_WEST_LOWER2_MAP = DUNGEON8_WEST_LOWER2_MAP;
window.DUNGEON8_EAST_LOWER2_MAP = DUNGEON8_EAST_LOWER2_MAP;
window.DUNGEON8_EAST_SECRET_MAP = DUNGEON8_EAST_SECRET_MAP;
...
window.LIGHTHOUSE_LANDING_3_MAP = LIGHTHOUSE_LANDING_3_MAP;
window.LIGHTHOUSE_LANTERN_MAP   = LIGHTHOUSE_LANTERN_MAP;
