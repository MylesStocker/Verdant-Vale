...
const DUNGEON8_WEST_MAP = [
  ...
  [63,63,62,62,62,62,62,62,123,62,62,62,62,62,62,63], //  6  ← tendon descent col 8 (→ raw chamber below)
...
const DUNGEON8_EAST_MAP = [
  ...
  [63,62,62,62,62,62,62,62,123,62,62,62,62,62,63,63], //  6  ← tendon descent col 8 (→ raw chamber below)
...
// ─── South Ruins — West Horror Branch, Lower Chamber  (16 × 15) ───────────────
// One raw level below the West Horror Branch, reached by climbing DOWN the
// tendon (123) in that chamber. DUNGEON3 tile set (62/63). Tendon ascent (124)
// at col 8 row 1 climbs back up. Same horror enemies (dungeonFloor 11 → the
// horror pool, via combat.js's floor-8+ fall-through). Tendon descent (123) at
// col 8 row 11 climbs deeper still, to the West Deeper Chamber.
const DUNGEON8_WEST_LOWER_MAP = [
  [63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],  //  0
  [63,63,63,63,63,63,63,63,124,63,63,63,63,63,63,63], //  1  ← tendon ascent col 8 (→ West Horror Branch)
  [63,63,63,63,63,63,62,62,62,62,63,63,63,63,63,63],  //  2
  [63,63,63,63,62,62,62,62,62,62,62,62,63,63,63,63],  //  3  ← arrive here (col 8) when descending
  [63,63,63,62,62,62,62,62,62,62,62,62,62,63,63,63],  //  4
  [63,63,62,62,62,62,63,62,62,63,62,62,62,62,63,63],  //  5  organic protrusions col 6, col 9
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,62,63],  //  6
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,62,63],  //  7
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,62,63],  //  8
  [63,63,62,62,62,63,62,62,62,62,63,62,62,62,63,63],  //  9  organic protrusions col 5, col 10
  [63,63,63,62,62,62,62,62,62,62,62,62,62,63,63,63],  // 10
  [63,63,63,63,62,62,62,62,123,62,62,62,63,63,63,63], // 11  ← tendon descent col 8 (→ West Deeper Chamber)
  [63,63,63,63,63,62,62,62,62,62,63,63,63,63,63,63],  // 12
  [63,63,63,63,63,63,62,62,62,63,63,63,63,63,63,63],  // 13
  [63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],  // 14
];

// ─── South Ruins — East Horror Branch, Lower Chamber  (16 × 15) ───────────────
// One raw level below the East Horror Branch, reached by climbing DOWN the
// tendon (123) in that chamber. DUNGEON3 tile set (62/63). Tendon ascent (124)
// at col 8 row 1 climbs back up. Same horror enemies (dungeonFloor 12 → the
// horror pool). Tendon descent (123) at col 8 row 11 climbs deeper still, to
// the East Deeper Chamber.
const DUNGEON8_EAST_LOWER_MAP = [
  [63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],  //  0
  [63,63,63,63,63,63,63,63,124,63,63,63,63,63,63,63], //  1  ← tendon ascent col 8 (→ East Horror Branch)
  [63,63,63,63,63,63,62,62,62,62,63,63,63,63,63,63],  //  2
  [63,63,63,63,62,62,62,62,62,62,62,62,63,63,63,63],  //  3  ← arrive here (col 8) when descending
  [63,63,62,62,62,62,62,62,62,62,62,62,62,63,63,63],  //  4
  [63,62,62,62,62,63,62,62,62,62,62,63,62,62,63,63],  //  5  organic protrusions col 5, col 11
  [63,62,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  6
  [63,62,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  7
  [63,62,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  8
  [63,63,62,62,62,62,62,63,62,62,62,62,62,63,63,63],  //  9  organic protrusion col 7
  [63,63,63,62,62,62,62,62,62,62,62,62,63,63,63,63],  // 10
  [63,63,63,63,62,62,62,62,123,62,62,63,63,63,63,63], // 11  ← tendon descent col 8 (→ East Deeper Chamber)
  [63,63,63,63,63,62,62,62,62,62,63,63,63,63,63,63],  // 12
  [63,63,63,63,63,63,62,62,62,63,63,63,63,63,63,63],  // 13
  [63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],  // 14
];

// ─── South Ruins — West Deeper Chamber  (16 × 15) ─────────────────────────────
// Two raw levels below the West Horror Branch, reached by climbing DOWN the
// tendon (123) in the West Lower Chamber. DUNGEON3 tile set (62/63). Tendon
// ascent (124) at col 8 row 1 climbs back up. Same horror enemies (dungeonFloor
// 13 → the horror pool). No stairs deeper.
const DUNGEON8_WEST_LOWER2_MAP = [
  [63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],  //  0
  [63,63,63,63,63,63,63,63,124,63,63,63,63,63,63,63], //  1  ← tendon ascent col 8 (→ West Lower Chamber)
  [63,63,63,63,63,63,62,62,62,62,63,63,63,63,63,63],  //  2
  [63,63,63,63,62,62,62,62,62,62,62,62,63,63,63,63],  //  3  ← arrive here (col 8) when descending
  [63,63,63,62,62,62,62,62,62,62,62,62,62,63,63,63],  //  4
  [63,63,62,62,63,62,62,62,62,62,62,63,62,62,63,63],  //  5  organic protrusions col 4, col 11
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,62,63],  //  6
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,62,63],  //  7
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,62,63],  //  8
  [63,63,62,62,62,62,63,62,62,63,62,62,62,62,63,63],  //  9  organic protrusions col 6, col 9
  [63,63,63,62,62,62,62,62,62,62,62,62,62,63,63,63],  // 10
  [63,63,63,63,62,62,62,62,62,62,62,62,63,63,63,63],  // 11
  [63,63,63,63,63,62,62,62,62,62,62,63,63,63,63,63],  // 12
  [63,63,63,63,63,63,62,62,62,62,63,63,63,63,63,63],  // 13
  [63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],  // 14
];

// ─── South Ruins — East Deeper Chamber  (16 × 15) ─────────────────────────────
// Two raw levels below the East Horror Branch, reached by climbing DOWN the
// tendon (123) in the East Lower Chamber. DUNGEON3 tile set (62/63). Tendon
// ascent (124) at col 8 row 1 climbs back up. Same horror enemies (dungeonFloor
// 14 → the horror pool). No stairs deeper.
const DUNGEON8_EAST_LOWER2_MAP = [
  [63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],  //  0
  [63,63,63,63,63,63,63,63,124,63,63,63,63,63,63,63], //  1  ← tendon ascent col 8 (→ East Lower Chamber)
  [63,63,63,63,63,63,62,62,62,62,63,63,63,63,63,63],  //  2
  [63,63,63,63,62,62,62,62,62,62,62,62,63,63,63,63],  //  3  ← arrive here (col 8) when descending
  [63,63,62,62,62,62,62,62,62,62,62,62,62,63,63,63],  //  4
  [63,62,62,62,63,62,62,62,62,62,62,62,63,62,63,63],  //  5  organic protrusions col 4, col 12
  [63,62,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  6
  [63,62,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  7
  [63,125,62,62,62,62,62,62,62,62,62,62,62,62,63,63], //  8  ← concealed passage col 1 (looks like wall; → hidden vault)
  [63,63,62,62,62,63,62,62,62,62,63,62,62,63,63,63],  //  9  organic protrusions col 5, col 10
  [63,63,63,62,62,62,62,62,62,62,62,62,63,63,63,63],  // 10
  [63,63,63,63,62,62,62,62,62,62,62,63,63,63,63,63],  // 11
  [63,63,63,63,63,62,62,62,62,62,63,63,63,63,63,63],  // 12
  [63,63,63,63,63,63,62,62,62,63,63,63,63,63,63,63],  // 13
  [63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],  // 14
];

// ─── South Ruins — East Deeper Chamber, Hidden Vault  (16 × 15) ───────────────
// A concealed treasure vault reached ONLY by walking into the disguised wall at
// DUNGEON8_EAST_LOWER2_MAP (r8 c1) — HORROR_SECRET_ENTRANCE, rendered identically
// to a horror wall. DUNGEON3 tile set (62/63). Deliberately encounter-free (a
// safe reward room). Vault exit (126) at col 8 row 1 leads back out. Holds the
// secret EvadeAll accessory chest (data.js).
const DUNGEON8_EAST_SECRET_MAP = [
  [63,63,63,63,63,63,63,63,63,63,63,63,63,63,63,63],  //  0
  [63,63,63,63,63,63,63,63,126,63,63,63,63,63,63,63], //  1  ← vault exit col 8 (→ East Deeper Chamber)
  [63,63,63,63,63,63,62,62,62,62,63,63,63,63,63,63],  //  2
  [63,63,63,63,62,62,62,62,62,62,62,62,63,63,63,63],  //  3  ← arrive here (col 8) when entering
  [63,63,63,62,62,62,62,62,62,62,62,62,62,63,63,63],  //  4
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  5
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  6
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  7  chest (EvadeAll) at col 8
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  8
  [63,63,62,62,62,62,62,62,62,62,62,62,62,62,63,63],  //  9
  [63,63,63,62,62,62,62,62,62,62,62,62,62,63,63,63],  // 10
  [63,63,63,63,62,62,62,62,62,62,62,63,63,63,63,63],  // 11
  [63,63,63,63,63,62,62,62,62,62,63,63,63,63,63,63],  // 12
  [63,63,63,63,63,63,62,62,62,63,63,63,63,63,63,63],  // 13
