...
const SCENARIOS = [
  ...
  { label: 'Second-tier vs Polwick gang (0 Potions)', level: 3, gear: 'second', enemies: ['enemy_smuggler_guard', 'enemy_polwick', 'enemy_essa'], potions: 0 },
  { label: 'Second-tier vs Polwick gang (2 Potions)', level: 3, gear: 'second', enemies: ['enemy_smuggler_guard', 'enemy_polwick', 'enemy_essa'], potions: 2 },
  ...
  { label: 'Intended late vs Pale Sentry', level: 7, gear: 'dragon', enemies: ['enemy_pale_sentry'], potions: 3 },
