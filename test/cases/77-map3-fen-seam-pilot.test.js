...
module.exports = {
  ...
  run() {
    ...
    assert.equal(audit.seamReadiness.totals.ALIGNS, 16, 'ALIGNS 16 (incl. the MAP3<->MAP3_N1 pilot)');
    ...
    assert.equal(V['MAP2|east'], 'NEEDS_REMAP', 'MAP2|east still NEEDS_REMAP (untouched)');
