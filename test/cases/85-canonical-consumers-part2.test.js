...
module.exports = {
  ...
  run() {
    ...
    assert.deepEqual(audit.seamReadiness.totals, { INTENTIONAL_DISCRETE: 4, BORDER: 24, ALIGNS: 46, BLOCKED: 42 }, 'seam audit: 46 ALIGNS / 0 NEEDS_REMAP / 4 INTENTIONAL_DISCRETE / 42 BLOCKED / 24 BORDER');
  },
};
