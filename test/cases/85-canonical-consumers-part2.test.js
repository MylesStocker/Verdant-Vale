...
module.exports = {
  ...
  run() {
    ...
    assert.deepEqual(audit.seamReadiness.totals, { INTENTIONAL_DISCRETE: 4, BORDER: 24, ALIGNS: 40, BLOCKED: 36 }, 'seam audit: 40 ALIGNS / 0 NEEDS_REMAP / 4 INTENTIONAL_DISCRETE / 36 BLOCKED / 24 BORDER');
  },
};
