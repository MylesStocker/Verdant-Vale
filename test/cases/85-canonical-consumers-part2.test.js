...
module.exports = {
  ...
  run() {
    ...
    assert.deepEqual(audit.seamReadiness.totals, { INTENTIONAL_DISCRETE: 4, BORDER: 26, ALIGNS: 26, BLOCKED: 4 }, 'seam audit unchanged: 26 ALIGNS / 0 NEEDS_REMAP / 4 INTENTIONAL_DISCRETE / 4 BLOCKED / 26 BORDER');
  },
};
