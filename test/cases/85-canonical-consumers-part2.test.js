...
module.exports = {
  ...
  run() {
    ...
    assert.deepEqual(audit.seamReadiness.totals, { INTENTIONAL_DISCRETE: 4, BORDER: 22, ALIGNS: 48, BLOCKED: 46 }, 'seam audit: 48 ALIGNS / 0 NEEDS_REMAP / 4 INTENTIONAL_DISCRETE / 46 BLOCKED / 22 BORDER');
  },
};
