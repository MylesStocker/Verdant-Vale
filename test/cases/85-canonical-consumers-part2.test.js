...
module.exports = {
  ...
  run() {
    ...
    assert.deepEqual(audit.seamReadiness.totals, { INTENTIONAL_DISCRETE: 4, BORDER: 24, ALIGNS: 26, BLOCKED: 22 }, 'seam audit: 26 ALIGNS / 0 NEEDS_REMAP / 4 INTENTIONAL_DISCRETE / 22 BLOCKED / 24 BORDER (West Outfall + 3 North Basin scenery chunks)');
  },
};
