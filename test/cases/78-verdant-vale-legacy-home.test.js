...
module.exports = {
  ...
  run() {
    ...
    assert.deepEqual(audit.seamReadiness.totals, { INTENTIONAL_DISCRETE: 4, BORDER: 22, ALIGNS: 42, BLOCKED: 40 }, 'totals: ALIGNS 42 / NEEDS_REMAP 0 / INTENTIONAL_DISCRETE 4 / BLOCKED 40 / BORDER 22');
