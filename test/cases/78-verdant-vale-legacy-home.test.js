...
module.exports = {
  ...
  run() {
    ...
    assert.deepEqual(audit.seamReadiness.totals, { INTENTIONAL_DISCRETE: 4, BORDER: 26, ALIGNS: 28, BLOCKED: 30 }, 'totals: ALIGNS 28 / NEEDS_REMAP 0 / INTENTIONAL_DISCRETE 4 / BLOCKED 30 / BORDER 26');
    ...
    assert.equal(g.run('continuousSeamEntries().length'), 28, '28 eligible directed seams (14 pairs)');
