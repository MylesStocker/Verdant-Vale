...
module.exports = {
  ...
  run() {
    ...
    assert.deepEqual(audit.seamReadiness.totals, { INTENTIONAL_DISCRETE: 4, BORDER: 24, ALIGNS: 38, BLOCKED: 34 }, 'totals: ALIGNS 38 / NEEDS_REMAP 0 / INTENTIONAL_DISCRETE 4 / BLOCKED 34 / BORDER 24');
