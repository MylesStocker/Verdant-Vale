...
module.exports = {
  ...
  run() {
    ...
    assert.equal(ents.length, 20, 'all 20 placed outdoor maps are bound');
    ...
    const expected = { MAP:'overworld', MAP2:'map2', MAP3:'map3', MAP4:'map4', MAP5:'overworld',
      ...
      DRENWICK_WEST_OUTFALL_MAP:'drenwick_west_outfall', NORTH_BASIN_N_MAP:'north_basin_n', NORTH_BASIN_NE_MAP:'north_basin_ne', NORTH_BASIN_NE2_MAP:'north_basin_ne2', NORTH_BASIN_E_MAP:'north_basin_e' };
    ...
    assert.equal(ents.filter(e => e.unambiguous).length, 17, 'the other 17 bindings are unique');
