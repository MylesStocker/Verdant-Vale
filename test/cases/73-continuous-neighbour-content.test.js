...
module.exports = {
  ...
  run() {
    ...
    assert.equal(ents.length, 30, 'all 30 placed outdoor maps are bound');
    ...
    const expected = { MAP:'overworld', MAP2:'map2', MAP3:'map3', MAP4:'map4', MAP5:'overworld',
      ...
      NORTH_BASIN_S_MAP:'north_basin_s', NORTH_BASIN_SE_MAP:'north_basin_se', EAST_CAUSEWAY_MAP:'east_causeway', NORTH_BASIN_C_MAP:'north_basin_c', NORTH_BASIN_SW_MAP:'north_basin_sw', NORTH_BASIN_MIREWOOD_MAP:'north_basin_mirewood',
    ...
    assert.equal(ents.filter(e => e.unambiguous).length, 27, 'the other 27 bindings are unique');
