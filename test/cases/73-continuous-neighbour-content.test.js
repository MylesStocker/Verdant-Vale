...
module.exports = {
  ...
  run() {
    ...
    assert.equal(ents.length, 25, 'all 25 placed outdoor maps are bound');
    ...
    const expected = { MAP:'overworld', MAP2:'map2', MAP3:'map3', MAP4:'map4', MAP5:'overworld',
      ...
      DRENWICK_EAST_CANAL_MAP:'drenwick_east_canal', THORNMERE_NORTH_FEN_MAP:'thornmere_north_fen', THORNMERE_UPPER_SHALLOWS_MAP:'thornmere_upper_shallows',
      NORTH_BASIN_S_MAP:'north_basin_s', NORTH_BASIN_SE_MAP:'north_basin_se', NORTH_BASIN_C_MAP:'north_basin_c', NORTH_BASIN_SW_MAP:'north_basin_sw',
    ...
    assert.equal(ents.filter(e => e.unambiguous).length, 22, 'the other 22 bindings are unique');
