...
module.exports = {
  ...
  run() {
    ...
    assert.equal(ents.length, 23, 'all 23 placed outdoor maps are bound');
    ...
    const expected = { MAP:'overworld', MAP2:'map2', MAP3:'map3', MAP4:'map4', MAP5:'overworld',
      ...
      DRENWICK_EAST_CANAL_MAP:'drenwick_east_canal',
    ...
    assert.equal(ents.filter(e => e.unambiguous).length, 20, 'the other 20 bindings are unique');
