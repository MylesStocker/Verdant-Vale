...
module.exports = {
  ...
  run() {
    ...
    // ── 7. All 42 eligible directed segment entries operate under the default ──
    assert.equal(R('continuousSeamEntries().length'), 42, '42 eligible directed segment entries');
    assert.equal(R('continuousSeamEntries().length/2'), 21, '21 reciprocal segment pairs');
