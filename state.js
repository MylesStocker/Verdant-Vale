...
let inHollisFarmhouse    = false; // true inside Hollis's farmhouse on MAP (row 9 col 3)
let inWrennaCottage      = false; // true inside Wrenna's cottage on MAP (row 12 col 2)
...
let inMireVault          = false; // true when inside Mirethyst's Vault (entered from Northern Thornmere Fen)
...
let inLighthouse         = false; // true on any discrete floor of the abandoned Thornmere lighthouse
